    ...
    if("<%=subscribe%>" == "1"){
	   ...
	   // xmlHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded"); 
    	...
    	diag.okButton.onclick = function(){
    			diag.close();
    			setEnable();
    			window.location="http://mp.weixin.qq.com/s?__biz=MzI0NTAxMDc4Mg==&mid=212223460&idx=1&sn=f89b729ac38ac15047bc311cfbdeb730&scene=0#rd";  
    	};
    }
}
...
function baoming(){
	window.location="hua/baoming.jsp";  
}
...
<div id='wx_pic' style='margin:0 auto;display:none;'>
	<img src='../images/logoi.jpg'/>
</div>

</head>
<body class="weixinstyle" onload="init()">

<div id="welcome" style="position:absolutely;width:100%;height:100%">
	<img src='images/background1.jpg' width="100%" height="100%"/>
	</div>
<div class="wapwrap" id="mainpage" style="display:none">
...
<div class='votetitle'>
<h4 style="height: 1.5em;line-height: 1.5em;font-weight:bolder">蒙面花王选拔赛
...
<div class='blockcell'>
<i class='icon-time'></i> 投票时间：2015-10-10 至 2015-10-30
</div>
<div class='blockcell'>
...
蒙面花王奖品：价值5288元的iphone6s一台！<br/>
最具创意奖奖品：价值258元27朵花坊姑娘意大利进口皂花礼盒！<br/>
最具气质奖奖品：价值168元19朵花坊姑娘意大利进口皂花一束！<br/>
其余进入八强的五位参赛者均可获得由花坊姑娘提供的价值58元的精美皂花小礼盒！<br/>
</div>
...
<input  class="btn btn-info wxvotebutton" type="button"  onclick="go()" value="搜索"  style="width:100px;vertical-align:middle;margin-top: 6px;margin-bottom: 10px;"/>
	...
	<div class='voteoplist' >
		...
		%>
			<div class='wxop' >
					<div class='wxopimg '>
							<a href="hua/showDetail.jsp?id=<%=id%>&pic=<%=pic %>&name=<%=name%>&pocard=<%=pocard%>&openid=<%=openid%>&subscribe=<%=subscribe%>">
								<img src="<%=pic %>"  name="1"  />
							</a>
					</div>
					<div class='wxoptxt'>
