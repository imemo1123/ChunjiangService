...
.yahei{
	...
	.mybody{ background: url(../images/back3.jpg) no-repeat;
	background-size:100%;
	width: 100%;height: 100%;
            }
            .mydiv{background: rgba(255,255,255,0.4);padding:30px;}
            .myinput {background: rgba(255,255,255,0.4)}
</style>
...
function init(){
	...
	$("#areas").get(0).selectedIndex=1;
	$('#areas').selectmenu('refresh', true);
}
</script>
</head>
<body onload="init()">
...
<div class="mybody">
	<div data-role="header" data-theme="c">
		...
		<h1 style="margin:0 auto;margin-top:.6em;margin-bottom:.8em"><span class="yahei">篮球宝贝在线报名</span></h1>
	</div>
	<div style="margin: 20px 20px 20px 20px;" class="mydiv">
         <form name="submitForm" id="submitForm" encType="multipart/form-data" method="post" action="../baoming">
          	...
          	<span>赛区：</span><%=handle.getAreaSelect("areas") %>
	...
	<div style="margin:  10px auto;margin-top: 20px;width:240px">
		<div style=" display:inline;">
		
			<div class="qrcode" >
			<img src="../images/yq0KEVV6b7mABwZyAAJWUib7fLg942.png" width="240px" height="150px">
			</div>
			<div style="margin:10 auto;text-align: center">
			<span class="yahei">微信公众号</span>
			</div>
		</div>
